...
const api: DesktopApi = {
  ...
  listOpenTurns: (threadId) => ipcRenderer.invoke("newde:listOpenTurns", threadId),
  listRecentInactiveTurns: (threadId, limit) => ipcRenderer.invoke("newde:listRecentInactiveTurns", threadId, limit),
  archiveAgentTurn: (turnId) => ipcRenderer.invoke("newde:archiveAgentTurn", turnId),
