...
const api: DesktopApi = {
  ...
  listAgentTurns: (streamId, threadId, limit) => ipcRenderer.invoke("oxplow:listAgentTurns", streamId, threadId, limit),
  listOpenTurns: (threadId) => ipcRenderer.invoke("oxplow:listOpenTurns", threadId),
  listRecentInactiveTurns: (threadId, limit) => ipcRenderer.invoke("oxplow:listRecentInactiveTurns", threadId, limit),
  archiveAgentTurn: (turnId) => ipcRenderer.invoke("oxplow:archiveAgentTurn", turnId),
