...
const api: DesktopApi = {
  ...
  listSiblingWorktrees: (streamId) => ipcRenderer.invoke("oxplow:listSiblingWorktrees", streamId),
  ...
  closeThread: (streamId, threadId) => ipcRenderer.invoke("oxplow:closeThread", streamId, threadId),
  reopenThread: (streamId, threadId) => ipcRenderer.invoke("oxplow:reopenThread", streamId, threadId),
  listClosedThreads: (streamId) => ipcRenderer.invoke("oxplow:listClosedThreads", streamId),
  ...
  gitPushCurrentTo: (streamId, remote, branch) => ipcRenderer.invoke("oxplow:gitPushCurrentTo", streamId, remote, branch),
  gitPullRemoteIntoCurrent: (streamId, remote, branch) => ipcRenderer.invoke("oxplow:gitPullRemoteIntoCurrent", streamId, remote, branch),
  ...
  recordPageVisit: (input) => ipcRenderer.invoke("oxplow:recordPageVisit", input),
  listRecentPageVisits: (opts) => ipcRenderer.invoke("oxplow:listRecentPageVisits", opts),
