...
pub fn specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            commands::dashboards::list_dashboards,
            ...
            commands::dashboards::remove_dashboard_item,
            commands::dashboards::reorder_dashboard_items,
            // backlog
            ...
            commands::snapshot::diff_endpoints,
            commands::snapshot::read_endpoint_files_content,
            ...
            commands::metrics::set_metrics_enabled,
            ...
            commands::terminal::lookup_terminal_session,
            // menu
