...
rpc_dispatch! {
    ...
    "list_metric_samples" => commands::metrics::list_metric_samples { metric_key: String, limit: Option<i64>, group_by: Option<String>, from_ms: Option<i64>, to_ms: Option<i64> },
    ...
    "metric_series" => commands::metrics::metric_series { measure_key: String, aggregation: String, group_by: Option<String>, min_value: Option<f64>, severity: Option<String>, from_ms: Option<i64>, to_ms: Option<i64> },
