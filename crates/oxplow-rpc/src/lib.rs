...
rpc_dispatch! {
    ...
    // lsp
    "open_lsp_client" => commands::lsp::open_lsp_client { stream_id: String, language_id: String },
    "send_lsp_message" => commands::lsp::send_lsp_message { client_id: String, payload: String },
